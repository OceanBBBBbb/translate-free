...
//  static TranslateConcurrentCache cache = new TranslateConcurrentCache();
  ...
  public String tryCn2en(String text,boolean prio) {
    return tryCn2en(text, 1, DEFAULT_MAX_TRY,prio);
